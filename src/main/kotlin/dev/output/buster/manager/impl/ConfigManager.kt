...
import dev.output.buster.event.eventListener
import dev.output.buster.event.impl.CloseGameEvent
...
object ConfigManager: AbstractManager() {
    ...
    private val path = File(Buster.NAME)
    ...
    private fun loadModule(mod: Module) {
        ...
        try {
            ...
            LoggerHelper.logInfo("Loading config failed! Please delete \"${Buster.NAME}\" folder and retry")
        }
